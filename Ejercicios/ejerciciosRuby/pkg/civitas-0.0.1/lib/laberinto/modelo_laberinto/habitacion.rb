...
class Habitacion
  ...
  #  if get_lado(direccion)!=nil && get_lado(direccion).tipo==Tipo_separacion::PUERTA
   #   return true
  #  else @@total_intentos_fallidos = @@total_intentos_fallidos+1
  #  if @@tota_intentos_fallidos >= (total_vidas-1)
  #      puertaEncantada=Elemento_separador.nueva_puerta(self,get_lado(direccion).habitacion_al_otro_lado(self))
  #      return true
  #      else 
  #      return false
  #  end
